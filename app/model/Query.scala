...
/*  val ois = new ObjectInputStream(new FileInputStream("data/Hyperplane_16_11.lshstructure"))
  ...
  val lshs = new LSHStructure(new File("data/descriptors-decaf-random-sample-reduced-20000000.data"), () => new Hyperplane(12, () => new Random(rnd.nextLong())), 4)
  println("Structure Loaded!")

  // return the result generated by
  def getResults(imageId:String, range:Double, k:Int) : List[((String, Vector[Float]), Double)] = {
